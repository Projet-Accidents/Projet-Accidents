...
# Conditions accident
    ...
    if usagers_checkbox:
        ...
        if "Système de sécurité" in variables_usagers:
            ...
            image_path = r"C:\Users\macha\Desktop\Test_py\systeme_securite.png"
...
########## Véhicules
    if vehicules_checkbox:
        ...
        if "Type de véhicule" in variables_vehicule:
            ...
            image_path = r"C:\Users\macha\Desktop\Test_py\Catv_gravite.png"
            st.image(image_path, use_column_width=True)
        ...
        if "Point de choc" in variables_vehicule:
            st.write("##### Point de choc")
            image_path = r"C:\Users\macha\Desktop\Test_py\point_choc.png"
            st.image(image_path, use_column_width=True)
